...
import guru.nicks.jpa.repository.EnhancedJpaRepository;
...
public class FullTextSearchAwareEntitySteps {
    ...
    public void sortCriteriaAreInitializedWithPageAndSize(int pageNumber, int pageSize) {
        ...
        resultPageable = FullTextSearchAwareEntity.initSortCriteria(searchFilter,
                TestSearchFilter::getSearchText, pageable);
    }
