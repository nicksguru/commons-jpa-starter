 ...
 * extending the aggregate get this fragment automatically.
 * <p>
...
public interface EnhancedJpaSearchRepositoryFragment<T extends Persistable<ID>,
    ...
    /**
     * Finds entities by filter (<b>method implemented in {@link EnhancedJpaSearchRepositoryFragmentImpl}</b>). Looks
     * not for the original text but for its ngrams - this is what fuzzy search is. If the original words are shorter
     * than the minimum ngram length, they will NOT be found.
     * <p>
     ...
     * @return page of entities found
     * @see EnhancedJpaRepositoryFragment#createEntityGraph()
     */
     ...
     * {@link EnhancedJpaSearchRepositoryFragmentImpl}</b>). {@code JSON_CONTAINS (json_column, json_value)} function
     * returning 0/1 must be created in each DB, for unification.
     *
